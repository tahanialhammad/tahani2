@php
    ...
    $logoClass = request()->routeIs('welcome') ? 'icon-inverted' : 'icon-dark' ;
@endphp
...
<nav class="navbar navbar-expand-lg sticky-top {{ $navClass }}">
    <div class="container-fluid">
        <a class="navbar-brand" href="{{ route('dashboard') }}">
            <svg viewBox="0 0 150 150"  class="icon-xxl {{$logoClass}}"  xmlns="http://www.w3.org/2000/svg" style="height: 50px">
                <path
